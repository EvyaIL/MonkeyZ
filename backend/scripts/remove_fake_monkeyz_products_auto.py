...
async def remove_fake_monkeyz_products():
    ...
    try:
        ...
        # Remove the fake products automatically without asking for confirmation
        removed_count = 0
        if fake_products:
        ...
        # Return success
        return True, f"Successfully removed {removed_count} fake products"
...
if __name__ == "__main__":
    print("Starting automatic fake product removal script...")
    success, message = asyncio.run(remove_fake_monkeyz_products())
    if success:
