...
class ApiService {
    constructor() {
        this.endpoint = `${process.env.REACT_APP_NODE_BACKEND}`;
        this.token = null;
    ...
    put(url, data, params = null, contentType = "application/json") {
        return this.request("PUT", url, data, params, contentType);
    }
