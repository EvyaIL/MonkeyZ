  ...
  return (
    <footer className="bg-white dark:bg-gray-800 text-gray-800 dark:text-white py-8 px-4 mt-12 border-t border-gray-200 dark:border-gray-700">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        {/* Brand and copyright */}
        <div className="text-center md:text-start">          <span className="text-primary dark:text-accent font-bold text-xl">MonkeyZ</span> &copy; {currentYear}
        ...
        {/* Social media links */}
        <div className="flex gap-6 mt-2 md:mt-0">          <a 
